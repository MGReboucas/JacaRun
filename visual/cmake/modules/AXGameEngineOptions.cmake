set(AX_EXT_HINT OFF CACHE BOOL "Optional extensions" FORCE)
set(AX_ENABLE_3D OFF CACHE BOOL "2D prototype" FORCE)
set(AX_ENABLE_PHYSICS OFF CACHE BOOL "Physics lives in the shared core" FORCE)
set(AX_ENABLE_AUDIO OFF CACHE BOOL "Audio planned for a later milestone" FORCE)
set(AX_ENABLE_OPUS OFF CACHE BOOL "No audio yet" FORCE)
set(AX_ENABLE_HTTP OFF CACHE BOOL "Offline prototype" FORCE)
set(AX_ENABLE_WEBSOCKET OFF CACHE BOOL "Offline prototype" FORCE)
set(AX_ENABLE_MSEDGE_WEBVIEW2 OFF CACHE BOOL "No web views" FORCE)
set(AX_ENABLE_MFMEDIA OFF CACHE BOOL "No video yet" FORCE)
set(AX_ENABLE_MEDIA OFF CACHE BOOL "No video yet" FORCE)
set(AX_ENABLE_CONSOLE OFF CACHE BOOL "No remote console" FORCE)
